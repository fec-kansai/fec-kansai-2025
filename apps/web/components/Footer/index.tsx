...
export default function Footer() {
  return (
    <footer className="flex flex-col gap-14 md:gap-12 py-12 px-6 md:px-20 bg-black">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:items-center md:gap-0 justify-between">
        <div className="flex-1 flex items-center gap-4 mx-auto md:mx-0">
          <Text className="font-bold text-xs md:text-sm">運営団体</Text>
          <a
            href="https://k3jp.org/"
            className="text-[#C084FC] hover:text-[#A855F7] underline transition-duration-300 flex items-center gap-1 text-xs md:text-sm"
            target="_blank"
