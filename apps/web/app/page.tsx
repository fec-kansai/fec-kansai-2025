...
export default function Page() {
  return (
    <main className="flex-1 relative overflow-hidden">
      <MainVisual />
      {/* icons */}
      <div className="absolute left-[0%] top-[10%] w-[76px] md:w-[182px] animate-float5 rotate-20">
        <TsuutenkakuIcon className={styles["neon-icon"]} />
      </div>
      <div className="absolute left-[10%] top-[50%] w-[76px] md:w-[182px] animate-float5 rotate-20">
        <TowerOfSunIcon className={styles["neon-icon"]} />
      </div>
      <div className="absolute right-[3%] top-[15%] w-[76px] md:w-[182px] animate-float5 -rotate-10">
        <OctopusIcon className={styles["neon-icon"]} />
      </div>
      <div className="absolute right-[8%] top-[70%] w-[76px] md:w-[182px] animate-float5 -rotate-20">
