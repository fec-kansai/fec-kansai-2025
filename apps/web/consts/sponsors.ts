...
export const SPONSORS: readonly Sponsor[] = [
  {
    ...
    description:
      "ミイダスは、マッチングをゴールとした従来の人材サービスとは一線を画し、データとテクノロジーを駆使して、人と仕事、人と組織のフィッティングを科学しています。\nミイダスが提唱する客観的・数値的な評価に基づいた採用「アセスメントリクルーティング」が日本の採用・転職の常識を変え、適材適所を見い出します。",
  ...
  },
  {
    ...
    description:
      "ちょっと株式会社は、Next.jsやTypeScriptを中心としたモダン技術を活用し、スピーディかつ高品質なWebサイト・サービスの開発支援を行うフロントエンド特化の技術者集団です。\n大規模サイトのリニューアルやサーバーレスを活用したWebアプリ・モバイルアプリ開発まで幅広く対応し、技術選定からデザイン、運用保守まで一気通貫で支援します。\nUXに優れた「魅力的品質」を追求し、アクセシビリティやパフォーマンスの最適化にも注力することで、あらゆるデバイスで最高のユーザー体験を提供します。\nさらに独自開発のCMSプラットフォーム「Orizm」により、従来のCMSでは難しかったフルカスタマイズをスピーディかつ低コストに実現。\n業界特化のCMS開発や運用改善など、幅広いユースケースに対応可能です。\nお客様に寄り添い、技術的なパートナーとして課題解決とビジネス成長に貢献します。",
  ...
  },
  {
    ...
    description:
      "私たちカオナビは「'はたらく'にテクノロジーを実装し、個の力から社会の仕様を変える」をPurposeに掲げ、タレントマネジメント市場No.1（導入社数4,000社超）の『カオナビ』を開発・提供しています。\n性別、学歴、肩書きといったラベルにとらわれず、「個」の力が開かれる社会の実現を目指し、人材データベースを核とした人事DXからタレントマネジメントまで幅広いソリューションを展開。\n企業の人事業務を革新するタレントマネジメントシステムとして、多くの企業様にご活用いただいています。\nフロントエンド開発ではReact・TypeScriptを採用し、ユーザビリティを重視したUI/UX設計により、様々な利用者が直感的に操作できるシステムを追求。\nテクノロジーの力で働く人すべてが自分らしく活躍できる未来を創造します。\nFace you, Face next. 向き合おう、すべての人が先へ進めるように。",
  ...
  },
  {
    ...
    description:
      "株式会社カケハシは日本の医療システムの再構築を目指すヘルステックスタートアップ企業です。テクノロジーを駆使し、患者さんにとってより良い医療を医療現場にとって持続可能な形で実現します。\n薬局体験アシスタント「Musubi」のほか、複数プロダクトを開発・提供し、国内の薬局の1万店舗超をカバー。\n服薬期間中の患者フォローによる治療効果最大化や医薬品の市中在庫可視化・安定供給などをサポートします。\n薬局や医療機関をはじめとしたステークホルダーとともに、より良い医療を実現するプラットフォームを構築していきます。",
  ...
  },
  {
    ...
    description:
      "ナレッジワークは「LIFE WITH ENABLEMENT できる喜びが巡る日々を届ける」をミッションに掲げ、一人ひとりのイネーブルメント（成果創出や能力向上）の実現を目指すスタートアップです。\n営業力を強化するセールスイネーブルメントAI「ナレッジワーク」を開発・提供し、営業担当の方々にとって欠かせない存在となることを目指しています。\nエンジニア組織は専門性豊かなメンバーで構成され、チーム横断で知見を共有しながら新しい技術的挑戦に取り組んでいます。\n私たちのプロダクトは、BtoCのように直感的で心地よいUI/UXを備え、現場の営業活動を力強くサポートします。\n顧客の声をスピーディかつ透明性をもってプロダクトに反映する開発体制や、再現性を重視したドキュメンテーション文化も私たちの強みです。また、AIとの協働を前提とした開発スタイルの標準化を積極的に推進しています。\n技術と文化の両面で挑戦を続けるナレッジワークと、ぜひ会場で未来のフロントエンドについて語りましょう！",
